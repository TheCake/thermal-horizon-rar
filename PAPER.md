...
**Draft v1.4 — assembled from the repository lab notebook (NOTES, Stages 1–4V); pre-circulation verification pass applied 2026-07-22 (INSPIRE reference verification, priority sweep of all novelty claims, flagged full-text checks — Appendix A); the Cookson et al. (2026) engagement with the perspective correction executed at the fit level (§7.4, Stage 4R); the measured zero-point coefficient (§4.3), the second-moment constraint with hierarchical M/L marginalization (§4.6), the mechanism specification (§2.4), and the oscillator scorecard (§9.1) added 2026-07-23. All numbers final as logged. Not for circulation before colleague review.**
...
| zero-point coefficient c₁ (§4.3) | 0.427 +0.290/−0.246 | ½ | −0.3σ |
