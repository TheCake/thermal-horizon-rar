...
**Draft v1.1 — assembled from the repository lab notebook (NOTES, Stages 1–4N); pre-circulation verification pass applied 2026-07-22 (INSPIRE reference verification, priority sweep of all novelty claims, flagged full-text checks — Appendix A). All numbers final as logged. Not for circulation before colleague review.**
...
Throughout, we practice what we call honest updating: every result passed a validation gate before being trusted; eleven claims made during this program were subsequently corrected or retracted by our own checks, and all eleven are documented in Appendix A rather than silently repaired. Every number quoted in this paper is produced by a named script in the public repository (Appendix B).
...
## Appendix A: the transparency record (eleven corrections)
...
- Chae, K.-H. 2022 (arXiv:2207.11069); 2023, ApJ 952, 128 (arXiv:2305.04613); 2024 (arXiv:2402.05720)
- Chae, K.-H., & Milgrom, M. 2022, ApJ 928, 24 (arXiv:2201.02109)
- Desmond, H., Hees, A., & Famaey, B. 2024, MNRAS (arXiv:2401.04796)
- Desmond, H., et al. 2026 (arXiv:2602.24035)
...
- Hernandez, X., Chae, K.-H., & Aguayo-Ortiz, A. 2024, MNRAS (arXiv:2312.03162)
