...
- the first coefficient-level tests of the thermal reading: the zero-point coefficient *measured* — **ĉ₁ = 0.450 (bootstrap 0.43 +0.29/−0.25), the predicted ½ interior at 0.7σ, the 0-branch excluded** — the ¼-branch disfavored, rung 2 honestly out of reach, and the identity's priority correctly assigned to Cadoni & Tuveri;
