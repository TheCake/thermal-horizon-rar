...
**Draft v1.2 — assembled from the repository lab notebook (NOTES, Stages 1–4N); pre-circulation verification pass applied 2026-07-22 (INSPIRE reference verification, priority sweep of all novelty claims, flagged full-text checks — Appendix A), plus the Cookson et al. (2026) full read and the Stage 4Q perspective audit it triggered (§7.4; correction #12). All numbers final as logged. Not for circulation before colleague review.**
