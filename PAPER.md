...
**Draft v1.3 — assembled from the repository lab notebook (NOTES, Stages 1–4T); pre-circulation verification pass applied 2026-07-22 (INSPIRE reference verification, priority sweep of all novelty claims, flagged full-text checks — Appendix A); the Cookson et al. (2026) engagement with the perspective correction executed at the fit level (§7.4, Stage 4R); the measured zero-point coefficient (§4.3) and the second-moment constraint (§4.6) added 2026-07-23. All numbers final as logged. Not for circulation before colleague review.**
